...
Total: **7,119** lines of code across **46** files in the top 5 languages.
...
- **Upstream**: <https://github.com/francoismichel/ssh3>
...
- **Releases**: 14 · **Merged PRs**: 82 · **Open PRs**: 9 · **Closed issues**: 19 · **Open issues**: 49 · **Commits**: 239
...
Reported by **6** distros on [repology.org](https://repology.org/project/ssh3). **5** are ✅ on the latest upstream release, **0** are ⚠️ on an older version.
...
_Snapshot: `data/card/260912.yml` · 2026-09-12T04:34:01Z._
